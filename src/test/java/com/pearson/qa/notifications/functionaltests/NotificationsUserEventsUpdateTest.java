 ...
 */
public class NotificationsUserEventsUpdateTest
{
    ...
    public void NotificationsUserEventsUpdate_test() throws Exception
    {
        ...
        notificationUserEventsCollection.setCreatedAt(notificationsUserEventsPostContext.getReturnedNotificationsUserEventsCollection().getCreatedAt());
        notificationUserEventsCollection.setUpdatedAt(notificationsUserEventsPostContext.getReturnedNotificationsUserEventsCollection().getUpdatedAt());
        notificationUserEventsCollection.setId(notificationsUserEventsPostContext.getReturnedNotificationsUserEventsCollection().getId());
        notificationUserEventsCollection.setLinks(notificationsUserEventsPostContext.getReturnedNotificationsUserEventsCollection().getLinks());

        //posting a single notification.
        NotificationsUserEventsUpdateContext notificationsUserEventsUpdateContext = notificationsContextFactory.getCreateNotificationsUserEventsUpdateContext(notificationUserEventsCollection);
        ...
        notificationsUserEventsUpdateContext.setModifiedNotificationsUserEventCollection(notificationUserEventsCollection);
